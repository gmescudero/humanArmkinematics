...
============================================================================*/
/* Removed all warnings by German Moreno Escudero -> 10/08/2022 */
...
int GA_steady_state(GA_Info_Ptr ga_info);
void GA_ss_init(GA_Info_Ptr ga_info);
void GA_trial(GA_Info_Ptr ga_info);
void GA_cum(GA_Info_Ptr ga_info, Chrom_Ptr c1,Chrom_Ptr c2);
int GA_set_fun(GA_Info_Ptr ga_info, char *fn_name, FN_Ptr fn_ptr);
int GA_select(GA_Info_Ptr ga_info, char *fn_name);
char *GA_name(GA_Info_Ptr ga_info);

static Chrom_Ptr child1, child2;

GA_Info_Ptr CF_alloc();
int CF_free(GA_Info_Ptr ga_info);
int CF_valid(GA_Info_Ptr ga_info);
void CF_reset(GA_Info_Ptr ga_info);
void CF_report(GA_Info_Ptr ga_info);
int CF_read(GA_Info_Ptr ga_info, char *cfg_name);
int CF_tokenize(char *line, char token[MAXTOK][STRLEN]);
void CF_verify(GA_Info_Ptr ga_info);

int X_set_fun(GA_Info_Ptr ga_info, char *fn_name, FN_Ptr fn_ptr);
int X_select(GA_Info_Ptr ga_info, char *fn_name);
char *X_name(GA_Info_Ptr ga_info);
int X_fun(GA_Info_Ptr ga_info, Chrom_Ptr parent_1, Chrom_Ptr parent_2, Chrom_Ptr child_1, Chrom_Ptr child_2);
int X_asex(GA_Info_Ptr ga_info, Chrom_Ptr parent_1, Chrom_Ptr parent_2, Chrom_Ptr child_1, Chrom_Ptr child_2);
int X_do_asex(Chrom_Ptr parent, Chrom_Ptr child);
void X_gen_xp(int idx_min, int idx_max, int *xp);
void X_gen_2_xp(int unique, int idx_min, int idx_max, int *xp1, int *xp2);
void X_gen_4_xp(int unique, int idx_min, int idx_max, int *xp1, int *xp2,int *xp3, int *xp4);
void X_init_kids(Chrom_Ptr parent_1, Chrom_Ptr parent_2, Chrom_Ptr child_1, Chrom_Ptr child_2);
int X_map(Gene_Type *allele, Chrom_Ptr chrom, int lo, int hi);
int X_simple(), X_uniform(), X_order1(), X_order2(), X_pos(), X_cycle(),
    X_pmx(), X_uox(), X_rox(), X_asex();

int FN_set_fun(GA_Info_Ptr ga_info, FN_Table_Ptr fn_table, char *fn_name, FN_Ptr fn_ptr, FN_Ptr *rtn_fun);
int FN_select(GA_Info_Ptr ga_info, FN_Table_Ptr fn_table, char *fn_name, FN_Ptr *rtn_fun);
char *FN_name(GA_Info_Ptr ga_info, FN_Table_Ptr fn_table, FN_Ptr fn_ptr);

int MU_set_fun(GA_Info_Ptr ga_info, char *fn_name, FN_Ptr fn_ptr);
int MU_select(GA_Info_Ptr ga_info, char *fn_name);
char *MU_name(GA_Info_Ptr ga_info);
void MU_fun(GA_Info_Ptr ga_info, Chrom_Ptr chrom);
...
int PL_free(Pool_Ptr pool);
int PL_valid(Pool_Ptr pool);
void PL_reset(Pool_Ptr pool);
void PL_eval(GA_Info_Ptr ga_info, Pool_Ptr pool);
char *PL_get_num(FILE *fid);
void PL_generate(GA_Info_Ptr ga_info, Pool_Ptr pool);
void PL_read(Pool_Ptr pool, long chrom_len, FILE *fid);
void PL_rand(Pool_Ptr pool, int pool_size, int chrom_len, int datatype);
void PL_rand01(Pool_Ptr pool, int pool_size, int chrom_len, int datatype);
void PL_stats(GA_Info_Ptr ga_info, Pool_Ptr pool);
void PL_index(Pool_Ptr pool);
int PL_update_ptf(GA_Info_Ptr ga_info, Pool_Ptr pool);
void PL_clean(Pool_Ptr pool, int idx_min, int idx_max);
void PL_append(Pool_Ptr pool, Chrom_Ptr chrom, int make_copy);
void PL_insert(Pool_Ptr pool, int index, Chrom_Ptr chrom, int make_copy);
void PL_remove(Pool_Ptr pool, int index);
void PL_move(Pool_Ptr pool, int idx_src, int idx_dst);
void PL_swap(Pool_Ptr pool, int idx1, int idx2);
int PL_update_ptf(GA_Info_Ptr ga_info, Pool_Ptr pool);

int RE_set_fun(GA_Info_Ptr ga_info, char *fn_name, FN_Ptr fn_ptr);
int RE_select(GA_Info_Ptr ga_info, char *fn_name);
char *RE_name(GA_Info_Ptr ga_info);
int RE_append(), RE_by_rank(), RE_first_weaker(), RE_weakest();
void RE_pick_best(GA_Info_Ptr ga_info, Chrom_Ptr p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2);
int RE_do_by_rank(GA_Info_Ptr ga_info, Pool_Ptr pool, Chrom_Ptr chrom);
void RE_fun(GA_Info_Ptr ga_info, Pool_Ptr pool, Chrom_Ptr p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2);

int SE_set_fun(GA_Info_Ptr ga_info, char *fn_name, FN_Ptr fn_ptr);
int SE_select(GA_Info_Ptr ga_info, char *fn_name);
char *SE_name(GA_Info_Ptr ga_info);
Chrom_Ptr SE_fun(GA_Info_Ptr ga_info, Pool_Ptr pool);
int SE_max_roulette(GA_Info_Ptr ga_info, Pool_Ptr pool), SE_min_roulette(GA_Info_Ptr ga_info, Pool_Ptr pool);
int SE_uniform_random(), SE_roulette(), SE_rank_biased();

int RP_long(GA_Info_Ptr ga_info, Pool_Ptr pool), RP_short(GA_Info_Ptr ga_info, Pool_Ptr pool);
void RP_config(GA_Info_Ptr ga_info);
int RP_time(GA_Info_Ptr ga_info, Pool_Ptr pool);
int RP_final(GA_Info_Ptr ga_info);
int RP_report(GA_Info_Ptr ga_info, Pool_Ptr pool);

Chrom_Ptr CH_alloc(int length);
void CH_resize(Chrom_Ptr chrom, int length);
int CH_free(Chrom_Ptr chrom);
int CH_valid(Chrom_Ptr chrom);
void CH_reset(Chrom_Ptr chrom);
void CH_copy(Chrom_Ptr src, Chrom_Ptr dst);
int CH_cmp(GA_Info_Ptr ga_info, Chrom_Ptr   a, Chrom_Ptr b);
void CH_print(Chrom_Ptr chrom);
void CH_verify(GA_Info_Ptr ga_info, Chrom_Ptr chrom);
...
{
   /*--- Error check ---*/
  if(!CH_valid(chrom)) return GA_ERROR;  //CC
...
----------------------------------------------------------------------------*/
int X_uniform(GA_Info_Ptr ga_info,
   Chrom_Ptr  parent_1,Chrom_Ptr parent_2,
   Chrom_Ptr  child_1,Chrom_Ptr child_2)
{
   unsigned i;
...
----------------------------------------------------------------------------*/
int X_order1(GA_Info_Ptr ga_info,
   Chrom_Ptr  parent_1,Chrom_Ptr parent_2,
   Chrom_Ptr  child_1,Chrom_Ptr child_2)
{
   int xp1, xp2;
...
----------------------------------------------------------------------------*/
int X_order2(GA_Info_Ptr ga_info,
   Chrom_Ptr  parent_1,Chrom_Ptr parent_2,
   Chrom_Ptr  child_1,Chrom_Ptr child_2)
{
   int xp1, xp2, xp3, xp4;
...
----------------------------------------------------------------------------*/
int X_cycle(GA_Info_Ptr ga_info,
   Chrom_Ptr  parent_1,Chrom_Ptr parent_2,
   Chrom_Ptr  child_1,Chrom_Ptr child_2)
{
   int xp, i;
...
----------------------------------------------------------------------------*/
int X_asex(GA_Info_Ptr ga_info,
   Chrom_Ptr  parent_1,Chrom_Ptr parent_2,
   Chrom_Ptr  child_1,Chrom_Ptr child_2)
{
   /*--- Make sure datatype is compatible ---*/
...
----------------------------------------------------------------------------*/
int MU_simple_random(GA_Info_Ptr ga_info,
   Chrom_Ptr chrom)
{
   int idx;
...
----------------------------------------------------------------------------*/
int MU_swap(GA_Info_Ptr ga_info,
   Chrom_Ptr chrom)
{
   Gene_Type tmp;
   int       i, j;
...
----------------------------------------------------------------------------*/
int MU_float_rnd_pert(GA_Info_Ptr ga_info,
   Chrom_Ptr chrom)
{
   int       i;
...
|   rnd float in [0..1] -- introduced by claudio 10/02/2004
----------------------------------------------------------------------------*/
int MU_float_random(GA_Info_Ptr ga_info,
   Chrom_Ptr chrom)
{
   int       i;
...
----------------------------------------------------------------------------*/
int MU_float_gauss_pert(GA_Info_Ptr ga_info,
     Chrom_Ptr chrom)
...
----------------------------------------------------------------------------*/
static int PL_cmp_min(const void *a_void,const void *b_void)
{
   Chrom_Ptr *a = (Chrom_Ptr*)a_void;
   Chrom_Ptr *b = (Chrom_Ptr*)b_void;
   if((*a)->fitness < (*b)->fitness)
      return -1;
   else if((*a)->fitness > (*b)->fitness)
      return 1;
...
----------------------------------------------------------------------------*/
static int PL_cmp_max(const void *a_void,const void *b_void)
{
   Chrom_Ptr *a = (Chrom_Ptr*)a_void;
   Chrom_Ptr *b = (Chrom_Ptr*)b_void;
   if((*a)->fitness < (*b)->fitness)
...
----------------------------------------------------------------------------*/
int RE_by_rank(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool,
   Chrom_Ptr      p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2)
{
   /*--- Error check ---*/
...
----------------------------------------------------------------------------*/
int RE_first_weaker(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool,
   Chrom_Ptr      p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2)
{
   int       i;
...
| Replace weakest
----------------------------------------------------------------------------*/
int RE_weakest(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool,
   Chrom_Ptr      p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2)
{
   Chrom_Ptr weakest;
...
----------------------------------------------------------------------------*/
void RE_pick_best(GA_Info_Ptr    ga_info,
   Chrom_Ptr      p1, Chrom_Ptr p2,Chrom_Ptr c1,Chrom_Ptr c2)
{
   int xp1, xp2;
...
----------------------------------------------------------------------------*/
int RP_short(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
   /*--- Error check ---*/
...
| print a long report
----------------------------------------------------------------------------*/
int RP_long(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
   int i, j;
...
| Uniform random
----------------------------------------------------------------------------*/
int SE_uniform_random(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
   /*--- Error check ---*/
...
| Roulette
----------------------------------------------------------------------------*/
int SE_roulette(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
   /*--- Error check ---*/
...
----------------------------------------------------------------------------*/
int SE_max_roulette(GA_Info_Ptr    ga_info,   Pool_Ptr       pool)
{
   int   i = 0;
...
----------------------------------------------------------------------------*/
int SE_min_roulette(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
   int   i = 0;
   float val = 0.0, spin_val;
...
| Rank biased
----------------------------------------------------------------------------*/
int SE_rank_biased(GA_Info_Ptr    ga_info,
   Pool_Ptr       pool)
{
